            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add Asset</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <?php
                        if(isset($_POST['submit']))
                        {
                            ...
                            $insert = mysqli_query($conn, "INSERT INTO `assets`(`id`, `name`, `subject`, `price`, `durability`, `purpose`, `available`, `description`, `user_id`) VALUES (null,'$name','$subject','$price','$durability','$purpose','$available','$desc', '$user_id')");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" method="post" action="add-asset.php">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="durability" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="available" required name="available" class="form-control" placeholder="Is asset in stock?">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="form-control" required name="desc" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
