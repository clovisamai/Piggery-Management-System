    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php 
                    $id = $_POST['expense_id'];
                    $query = mysqli_query($conn,"SELECT * FROM expenses WHERE id = '$id' ");
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" method="post" action="all-expenses.php">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="durability" class="form-control" placeholder="" required value="<?php  echo $row['durability']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="position" name="available" required class="form-control" placeholder="Is Expense in stock?" value="<?php  echo $row['available']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="form-control" name="desc" required rows="3"><?php  echo $row['description']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
